/*Dans cet exercices, il faudra créer une fonction qui va vérifier si un numéro de série est valide ou non.
 ...
 * @returns 0 : No Error, 1 : Wrong Format, 2 : group 1 isn't group 3 reversed, 3 : group 2 isn't group 3 times 7, 4 : total sum isn't 
 * a multiple of 10000
 */
...
//exemples de numéro de série avec les résultats attendus :
